...
function Checkout():ReactElement {
   ...
   const handleCheckout = useCallback(async()=>{
        try{
            const {data}:{data:{url:string|undefined,message:string|undefined,status:boolean|undefined}} = await axios.get(import.meta.env.VITE_API_BASE_URL+`/cart/checkout?cancel_url=https://omer-khaled.github.io/failedPage&success_url=https://omer-khaled.github.io/successPage`,{
                headers:{
